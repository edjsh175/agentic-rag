...
> **进度说明（2026-07-28）**：A1/A2 已收口；目录已迁入 已完成-*。文中「enabled=false / 图 chunk 延后」为当时主线口径；其后第 4 轮已 PASS，**本地 config.ini 可开全图，生产模板仍关**。


- **记录日期**：2026-07-22
- **状态**：**A1/A2 收口**（锚定层通过；语料债开放；图谱 chunk 召回已关闭延后）
- **目录**：`docs/3_待办清单/知识图谱语义抽取/已完成-主干锚定检索与关系可答/`
