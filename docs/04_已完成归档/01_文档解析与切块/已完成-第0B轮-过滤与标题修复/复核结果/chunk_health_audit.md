# Chunk 健康审计报告（Round 0B Recheck）

- 生成时间：`2026-07-15T01:00:13.768631+00:00`
- 只读：`True`
- 语料快照哈希：`19421c7f8fb3124f`
- 代码指纹：`0770c14302e597ad`
...
解析文档数：8；过滤前块数：731；过滤后块数：730；过滤比例：0.14%

| 文档 | 过滤前 | 过滤后 | 过滤数 | 比例 | 主因 |
|---|---:|---:|---:|---:|---|
| `41bab783fa8840fd8c24a34840a4484d.pdf` | 227 | 227 | 0 | 0.0% | `` |
| `2026陕西耕地保护系统问题收集.docx` | 5 | 5 | 0 | 0.0% | `` |
| `实景三维新功能.txt` | 20 | 20 | 0 | 0.0% | `` |
| `StampServer用户手册_Rocky9 .docx` | 234 | 234 | 0 | 0.0% | `` |
| `StampTools用户手册.docx` | 106 | 106 | 0 | 0.0% | `` |
| `StampWebRTC用户手册.docx` | 114 | 113 | 1 | 0.88% | `toc_marker` |
| `东方通用户手册_Rocky9.doc` | None | None | None | None% | `` |
| `矢量瓦片接口说明.doc` | None | None | None | None% | `` |
| `0e57a89c3a3e-Linux--如何安装rockyLinux9虚拟机.md` | 8 | 8 | 0 | 0.0% | `` |
| `b8aa16233693-MySQL数据库_数据类型与表约束.md` | 17 | 17 | 0 | 0.0% | `` |
