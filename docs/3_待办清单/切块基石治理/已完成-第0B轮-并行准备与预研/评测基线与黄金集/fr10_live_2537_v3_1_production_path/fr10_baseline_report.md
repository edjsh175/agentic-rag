...
- generated_at: `2026-07-20T06:27:38.058865+00:00`
- mode: `retrieval`
- gold: `docs\3_待办清单\切块基石治理\已完成-第0B轮-并行准备与预研\评测基线与黄金集\multi_chunk_qa_gold_v3_1.json`
- total: **120**
- pass_rate: **38.33%**
- mean_completeness: **63.50%**
- mean_evidence_recall: **66.11%**
- forbidden_rate: **0.00%**
