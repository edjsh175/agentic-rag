...
并行准备阶段曾约定：不写正式库、不改 Loader 主路径。上述边界在 **2026-07-16 0G 重建与豁免切换后已解除**；当前 live 状态以 [GOV-0G-20260716-001](../../进行中-第0C轮-切块合并与隔离验证/GOV-0G-20260716-001-门禁未过人工豁免上线.md) 为准。
...
| 本目录设计与基线 | 并行包已交付 |
| Round 0C | 生产接线 + 隔离验收 ✅ |
| Round 0G | 已重建；**人工豁免上线**；门禁账见 [GOV-0G-20260716-001](../../进行中-第0C轮-切块合并与隔离验证/GOV-0G-20260716-001-门禁未过人工豁免上线.md) |
