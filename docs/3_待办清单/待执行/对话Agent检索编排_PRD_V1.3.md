...
| 关联文档 | [对话上下文机制改进 PRD（Phase 0–2 已结项）](../../2_历史记录与总结/2026-08-11/2026-08-11-对话上下文机制改进PRD.md)、[反问指称唯一性 PRD](../知识图谱语义抽取/待执行-反问指称唯一性与二次开发直达/2026-08-14-反问指称唯一性与二次开发直达整改PRD.md)、[用户偏好记忆与反问继承系统-PRD](用户偏好记忆与反问继承系统-PRD.md)、[歧义消解规则管理系统-PRD](歧义消解规则管理系统-PRD.md)、[2026-07-20-RAG架构升级PRD](2026-07-20-RAG架构升级PRD.md) |

> **阅读说明**：本文定义目标架构与分阶段改造，不替代现状说明。现行行为以 `rag.py` / `DialogueUnderstanding` / `/query/stream` 为准。 **现行版本为 V1.3。**
>
