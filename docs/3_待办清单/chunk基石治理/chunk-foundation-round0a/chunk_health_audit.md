# Chunk 健康审计报告（Round 0A）

- 生成时间：`2026-07-14T08:11:47.300774+00:00`
- 只读：`True`
- 语料快照哈希：`19421c7f8fb3124f`
- 代码指纹：`44271119ecb0b564`
...
- `command_like` | `StampServer用户手册_Rocky9 .docx` | `操作系统安装 > 创建虚拟机 > CD/DVD设置`
...
解析文档数：8；过滤前块数：1100；过滤后块数：658；过滤比例：40.18%

| 文档 | 过滤前 | 过滤后 | 过滤数 | 比例 | 主因 |
|---|---:|---:|---:|---:|---|
| `41bab783fa8840fd8c24a34840a4484d.pdf` | 227 | 146 | 81 | 35.68% | `mixed_script_token` |
| `2026陕西耕地保护系统问题收集.docx` | 4 | 2 | 2 | 50.0% | `mixed_script_token` |
| `实景三维新功能.txt` | 12 | 5 | 7 | 58.33% | `compact_too_short` |
| `StampServer用户手册_Rocky9 .docx` | 519 | 303 | 216 | 41.62% | `mixed_script_token` |
| `StampTools用户手册.docx` | 200 | 135 | 65 | 32.5% | `mixed_script_token` |
| `StampWebRTC用户手册.docx` | 117 | 49 | 68 | 58.12% | `mixed_script_token` |
| `东方通用户手册_Rocky9.doc` | None | None | None | None% | `` |
| `矢量瓦片接口说明.doc` | None | None | None | None% | `` |
| `0e57a89c3a3e-Linux--如何安装rockyLinux9虚拟机.md` | 5 | 5 | 0 | 0.0% | `` |
| `b8aa16233693-MySQL数据库_数据类型与表约束.md` | 16 | 13 | 3 | 18.75% | `mixed_script_line` |
