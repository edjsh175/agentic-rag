...
- generated_at: `2026-07-15T06:19:29.400011+00:00`
...
- all chunks before/after: `366 -> 282`

| | count | lt100 | lt200 | gt1200 |
|---|---:|---:|---:|---:|
| before | 341 | 33.7% | 59.2% | 3.5% |
| after | 243 | 2.5% | 9.5% | 0.0% |
| PRD gate | - | <=5% | <=15% | <=5% |
...
- section_id raw duplicates (includes within-doc): 39 (occurrences 141)
- chunk_uid duplicates: **0** (occurrences 0)
- source_document_id unique values: 3 / 282 chunks
- broken prev/next: **0**
...
- elements -> final: `181 -> 153`
- ordinary-text lt200: `51.5% -> 8.1%`
- median chars: `188 -> 452`
...
- ordinary-text lt200: `59.5% -> 10.6%`
- median chars: `156 -> 460`
...
- ordinary-text lt200: `72.6% -> 11.5%`
- median chars: `125 -> 380`
