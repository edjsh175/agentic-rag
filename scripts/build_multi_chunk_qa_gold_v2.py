...
SEED = ROOT / "docs/04_已完成归档/01_文档解析与切块/已完成-第0A轮-基线审计与问题定位/multi_chunk_qa_gold.json"
AUDIT = ROOT / "docs/04_已完成归档/01_文档解析与切块/已完成-第0A轮-基线审计与问题定位/审计产物/chunk_health_audit.json"
OUT = ROOT / "docs/04_已完成归档/01_文档解析与切块/已完成-第0B轮-并行准备与预研/评测基线与黄金集/multi_chunk_qa_gold_v2.json"
